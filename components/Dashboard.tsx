  ...
  return (
    <div className="space-y-8">
      ...
      {totalPages > 0 ? (
        ...
        <div className="text-center bg-gray-800/50 ring-1 ring-white/10 rounded-lg p-12">
            <h2 className="text-2xl font-bold text-white">Welcome to the Command Center!</h2>
            <p className="mt-2 text-gray-400">It looks like you don't have any pages connected yet. Let's change that.</p>
            <button
                onClick={onAddNewPage}
                className="mt-6 flex items-center mx-auto space-x-2 px-6 py-3 text-base font-medium text-white bg-cyan-600 rounded-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-cyan-500 transition-colors"
            >
